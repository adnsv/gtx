...
constexpr char const* POLYLINE_VERTEX_SHADER_GLSL = R"(
#version 320 es
...
constexpr char const* POLYLINE_GEOMETRY_SHADER_GLSL = R"(
#version 320 es
...
constexpr char const* POLYLINE_FRAGMENT_SHADER_GLSL = R"(
#version 320 es
